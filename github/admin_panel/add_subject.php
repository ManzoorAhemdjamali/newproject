		...
		<div class="row">
			...
			<div class="col-md-9  my-4">
				<div class="container bg-white shadow py-2 ">
					<h4 class="text-primary"><i class="fa fa-list"></i> Subjects</h4><hr>
				<div class="container">
			<div class="row">
				...
				<div class="col-md-4">
					<div class="container form-group">
						<select class="form-control">
							...
							<option>6st Class</option>
							<option>7nd Class</option>
							<option>8rd Class </option>
		...
		<div class="container">
			...
			<div class="container table-responsive">
				<table class="table">
					<thead>
						<tr>
							<th>#</th><th>Class</th><th>Subjects</th><th></th>
						
						</tr>
					</thead>
					<tbody>
						<tr>
							<td>1</td><td>6th</td><td>English</td>
							<td>
						...
						<tr>
							<td>2</td><td>6th</td><td>History</td>
							<td>
								<a href="#" class="btn btn-info">
									<i class="fa fa-trash"></i>
								</a>
						...
						<tr>
							<td>3</td><td>8th</td><td>Accounting</td>
							<td>
								<a href="#" class="btn btn-info">
									<i class="fa fa-trash"></i>
								</a>
